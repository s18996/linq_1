...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps
                            .Where(emp => emp.Ename == "Władysław Torzewski")
                            .Select(emp => new
                            {
                                Nazwisko = emp.Ename,
                                Praca = emp.Job
        ...
        {
            var result = Emps.Aggregate((highest, next) => highest.Salary < next.Salary ? next : highest);
        }
